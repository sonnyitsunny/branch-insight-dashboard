...
SOURCES: tuple[Source, ...] = (
    ...
    Source(key="product_ai", module=product_ai, required=False),
    Source(key="return_ai", module=return_ai, required=False),
    Source(key="digital6_ai", module=digital6_ai, required=False),
